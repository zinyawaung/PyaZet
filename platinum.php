...
<body>
    <div class="choice-container pt-5">
      <a href="seat.php" class="btn btn-outline-danger rounded-circle" role="button"><i class="fas fa-arrow-circle-left"></i></a>
      <label class="mr-1 font-playfair">Select a Class</label>
      <select id="choice" class="font-playfair rounded">
        <option value="5000"><?php echo $_SESSION['silver']="Platinum"; ?></option>
      </select>
    </div>
    ...
    <div class="container">
      ...
      <div class="container font-quicksand">
        ...
        <?php platinum("P1","P2","P3","P4","P5","P6","P7","P8","P9","P10"); ?>
        <?php platinum("P12","P12","P13","P14","P15","P16","P17","P18","P19","P20"); ?>
        <?php platinum("P21","P22","P23","P24","P25","P26","P27","P28","P29","P30"); ?>
   ...
   <p class="text-center font-playfair">
     ...
     <a href="step1.php" class="text-center btn btn-outline-danger font-size-27 font-playfair">Confirm</a>
