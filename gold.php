...
<body>
    <div class="choice-container pt-5">
      ...
      <select id="choice" class="rounded font-playfair">
        <option value="3000"><?php echo $_SESSION['silver']="Gold"; ?></option>
      </select>
    </div>
    ...
    <div class="container">
      ...
      <div class="container font-quicksand">
        ...
        <?php gold("G1","G2","G3","G4","G5","G6","G7","G8","G9","G10"); ?>
        <?php gold("G12","G12","G13","G14","G15","G16","G17","G18","G19","G20"); ?>
        <?php gold("G21","G22","G23","G24","G25","G26","G27","G28","G29","G30"); ?>
