...
body {
  background-color:#000201;opacity: 95%;
  color: #fff;
  display: flex;
...
<body>
    <div class="choice-container pt-5">
      ...
      <select id="choice">
        <option value="2000">Silver</option>
        <option value="3000">Gold</option>
        <option value="5000">Platinum</option>
        <option value="9500">Diamond</option>
      </select>
    </div>
    ...
    <button class="text-center btn btn-outline-primary font-playfair">Confirm</button>
    <button class="text-center btn btn-outline-danger font-playfair">Cancle</button>
