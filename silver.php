...
<body>
    ...
    <div class="choice-container pt-5">
      <a href="seat.php" class="btn btn-outline-danger rounded-circle mr-2" role="button"><i class="fas fa-arrow-circle-left "></i></a>
      <label class="mr-1 font-playfair">Select a Class</label>
      <select name="category" id="choice" class="rounded font-playfair">
        <option value="2000"><?php echo $_SESSION['silver']="silver" ?></option>
      </select>
    </div>
    ...
    <div class="container font-quicksand">
      ...
      <div class="container">
        <?php silver("S1","S2","S3","S4","S5","S6","S7","S8","S9","S10"); ?>
        <?php silver("S12","S12","S13","S14","S15","S16","S17","S18","S19","S20"); ?>
        <?php silver("S21","S22","S23","S24","S25","S26","S27","S28","S29","S30"); ?>
   ...
   ?>
    <p class="text-center font-playfair">
      You have selected<span id="count"><?php echo $_SESSION['seat']="0"; ?></span> seats for a price of $<span
        id="price"
        >0</span>
    </p>
   <?php ?> 
     <a href="step1.php" class="text-center btn btn-outline-danger font-size-27 font-playfair">Confrim</a>
    <a href="seat.php" class="text-center btn btn-outline-primary font-size-27 font-playfair">Cancle</a>
